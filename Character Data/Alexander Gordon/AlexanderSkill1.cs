...
public enum AlexanderJoystickMode
{
    FreeAngle,
    FourWays
}

public class AlexanderSkill1 : MonoBehaviour
{
    ...
    public AlexanderJoystickMode joystickMode = AlexanderJoystickMode.FreeAngle;
    ...
    void Movement()
    {
        ...
        if (joystickDirection != Vector2.zero)
        {
            ...
            switch (joystickMode)
            {
                case AlexanderJoystickMode.FreeAngle:
                    angle = Mathf.Atan2(joystickDirection.y, joystickDirection.x) * Mathf.Rad2Deg;
                    break;
                case AlexanderJoystickMode.FourWays:
